...
<!-- UsageSnippet language="php" operationID="listWebhooks" method="get" path="/v1/webhooks/" -->
```php
...
<!-- UsageSnippet language="php" operationID="createWebhook" method="post" path="/v1/webhooks/" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="deleteWebhook" method="delete" path="/v1/webhooks/{id}" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="getWebhook" method="get" path="/v1/webhooks/{id}" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="updateWebhook" method="patch" path="/v1/webhooks/{id}" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="testWebhook" method="post" path="/v1/webhooks/{id}/test" -->
```php
declare(strict_types=1);
