...
<!-- UsageSnippet language="php" operationID="listStatements" method="get" path="/v1/statements/" -->
```php
...
<!-- UsageSnippet language="php" operationID="getStatementDownloadUrl" method="get" path="/v1/statements/{id}/download" -->
```php
declare(strict_types=1);
