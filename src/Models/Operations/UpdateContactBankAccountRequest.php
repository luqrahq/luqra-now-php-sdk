...
class UpdateContactBankAccountRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $achAccountNumber, string $achRoutingNumber, UpdateContactSubTypeRequest $subType, ?string $bankName = null, ?string $swiftCode = null)
    {
