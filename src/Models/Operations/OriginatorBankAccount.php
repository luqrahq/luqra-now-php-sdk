...
class OriginatorBankAccount
{
    ...
    /**
     *
     * @var \Luqra\LuqraNowPhp\Models\Operations\OriginatorSubType $subType
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('subType')]
    #[\Speakeasy\Serializer\Annotation\Type('\Luqra\LuqraNowPhp\Models\Operations\OriginatorSubType')]
    public OriginatorSubType $subType;
     ...
     * @param  \Luqra\LuqraNowPhp\Models\Operations\OriginatorSubType  $subType
     * @param  ?string  $bankName
     * @param  ?string  $swiftCode
     * @phpstan-pure
     */
    public function __construct(string $achAccountNumber, string $achRoutingNumber, OriginatorSubType $subType, ?string $bankName = null, ?string $swiftCode = null)
    {
